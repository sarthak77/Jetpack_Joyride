...
Baloon::Baloon(float x, float y, float speed,float angle, float g) {
    ...
    this->object1 = create3DObject(GL_TRIANGLES, n*3, g_vertex_buffer_data, COLOR_CLAN, GL_FILL);
}

void Baloon::draw(glm::mat4 VP,float x,float y) {
